...
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "ghostlabel.io";
...
export const LOGO = "/transparent-logo-simple-wide-cal.png";
export const LOGO_ICON = "/transparent-logo-simple-wide-cal.png";
